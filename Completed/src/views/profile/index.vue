...
<html lang="en">
 ...
 <body>
  <div id="app">
   <div data-reactroot="">
    <div class="ant-layout ant-layout-has-sider" style="min-height: 200vh;">
          ...
          <div class="ant-col-8">
           <div class="profile-left">
            <div class="profile-info">
             ...
             <!-- 任务1：头像处做一个上传功能 -->
             <p class="profile-name">用户名</p>
             <p class="profile-email">872798462@qq.com</p>
             <p class="profile-operation"><a href="#">
             <button type="button" class="ant-btn profile-operate ant-btn-primary">
               <span>修改密码</span>
               </button></a>
               <a href="#"><button type="button" class="ant-btn profile-operate">
               <span>修改头像</span></button></a></p>
             <div class="profile-deadline">
              <p>当前时间：{{currentTime}}</p>
             </div>
            </div>
            <div class="tab-container" style="width: 300%;">
              <el-tabs style="margin-top:15px; margin-left: 15px;" type="border-card" >
              <el-tab-pane label="登陆日志">
                <div id="transverse">
                  <div id="logintime"><h3>登陆时间</h3></div>
                  <div id="loginplace"><h3>登陆地点</h3></div>
                  <div id="IPaddress"><h3>IP地址</h3></div>
                 </div>
                 <div id="transverse2">
                  <div id="logintime">{{currentTime}}</div>
                  <div id="loginplace">白宫</div>
                  <div id="IPaddress">0.0.0.0</div>
                 </div>
              </el-tab-pane>
              </el-tabs>
            </div>
            ...
            <div class="profile-main-info">
             ...
             <div class="profile-main-info-box">
              ...
              <p><span class="profile-info-option"><i class="anticon anticon-lock"></i>
                 是否检验:
                 </span><span class="profile-info-value">已检验</span></p>
...
#logintime, #loginplace, #IPaddress{
