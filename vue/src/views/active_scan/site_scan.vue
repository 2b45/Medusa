 <template>
   <div class="app-container">
     <div class="filter-container">
       ...
       <el-button class="filter-item" type="primary" @click="highlyScan">高级扫描</el-button>
     </div>
     <div class="filter-container">
       资产搜索：
    ...
    <!-- pagination 分页插件 -->
     <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="getList" />
      <!-- 弹出的内部窗口  代码逻辑是 点击按钮 触发handleCreate事件，在Script处预先定义dialogStatus
      <el-dialog :title="textMap[dialogStatus]"对dialogStatus赋值  根据状态参数的不同触发不同的事件
      -->
